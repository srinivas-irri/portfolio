            ...
            <div className="flex gap-2 items-center mb-6">
               ...
               <div className='flex flex-cols-2'>
                  ...
                  <div className='flex-1' >
                     <div className='flex-1'><h3 className='text-[#00eaff] text-md mb-4 text-left'>Education</h3></div>
                  ...
                  <div className='language_section'>
                     <div className='flex-1'><h3 className='text-[#00eaff] text-md mb-4 text-left'>Languages</h3></div>
                     <ul>
                     {languages.map((langs, index) => (
                       <li key={index} className='flex gap-3 items-center content-between text-sm pb-6 text-white '>
                         ...
                         <div className='flex gap-2 items-center rating'>
                           <span className='w-2 h-2 rounded-full bg-[#00eaff]'></span>
                           <span className='w-2 h-2 rounded-full bg-[#00eaff]'></span>
                           <span className='w-2 h-2 rounded-full bg-[#00eaff]'></span>
                           <span className='w-2 h-2 rounded-full bg-[#00eaff]'></span>
                           <span className='w-2 h-2 rounded-full bg-[#00eaff]'></span>
